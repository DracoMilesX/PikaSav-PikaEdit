...
namespace Pikaedit_Lib
{
    ...
    public class BoxGen4
    {
        ...
        /// </summary>
        public PokemonGen4[] pkmdata = new PokemonGen4[30];

        public BoxGen4()
        {
            for (int i = 0; i < 30; i++)
            {
                pkmdata[i] = new PokemonGen4();
                name = "";
                wallpaper = 0;
            }
        }

        public BoxGen4(PokemonGen4[] pkmdata)
        {
            this.pkmdata = pkmdata;
        }

        public BoxGen4(string name, byte wallpaper)
        {
