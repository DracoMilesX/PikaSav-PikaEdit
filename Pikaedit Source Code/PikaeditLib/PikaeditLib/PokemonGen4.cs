...
{
    /// <summary>
    /// Represents a Gen 4 Pokemon data as an object (All string data is in English)
    /// </summary>
    public class PokemonGen4
    {
        ...
        public byte hgssBall;
        public byte contest_Cool;
        public byte contest_Beauty;
        public byte contest_Cute;
        public byte contest_Smart;
        public byte contest_Tough;
        public byte contest_Sheen;
        /// <summary>
        /// Location met offset used in HGSS
        /// </summary>
        public string hgssLocationMet;
        /// <summary>
        /// Location Hatched offset used in HGSS
        /// </summary>
        public string hgssLocationHatched;
        ...
        /// <summary>
        /// Initialize variables using pkm data array
        /// </summary>
        private void Initialize()
        {
            int z = 0;
            pid = BitConverter.ToUInt32(data, 0x0);
            nature = PkmLib.natures[(int)(pid % 25)];
            ...
            saev = data[0x1c];
            sdev = data[0x1d];
            contest_Cool = data[0x1e];
            contest_Beauty = data[0x1f];
            contest_Cute = data[0x20];
            contest_Smart = data[0x21];
            contest_Tough = data[0x22];
            contest_Sheen = data[0x23];
            ...
            if (version == "Heart Gold" || version == "Soul Silver")
            {
                if (BitConverter.ToUInt16(data, 0x44) == 0)
                {
                    isHatched = false;
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x44)))
                    {
                        hgssLocationHatched = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x44))];
                    }
                    else
                    {
                        hgssLocationHatched = Convert.ToString(BitConverter.ToUInt16(data, 0x44));
                    }
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x46)))
                    {
                        hgssLocationMet = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x46))];
                    }
                    else
                    {
                        hgssLocationMet = Convert.ToString(BitConverter.ToUInt16(data, 0x46));
                    }
                }
                else
                {
                    ...
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x46)))
                    {
                        hgssLocationHatched = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x46))];
                    }
                    else
                    {
                        hgssLocationHatched = Convert.ToString(BitConverter.ToUInt16(data, 0x46));
                    }
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x44)))
                    {
                        hgssLocationMet = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x44))];
                    }
                    else
                    {
                        hgssLocationMet = Convert.ToString(BitConverter.ToUInt16(data, 0x44));
                    }
                }
            }
            int y = 0x48;
            ...
            while (z < 11)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            sequencet = "";
                            tempnick = char.ConvertFromUtf32(PkmLib.getGen5Char(value));
                        }
                        else
                        {
            ...
            while (z < 8)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            sequencet = "";
                            tempot = char.ConvertFromUtf32(PkmLib.getGen5Char(value));
                        }
                        else
                        {
            ...
            if (version != "Heart Gold" && version != "Soul Silver")
            {
                ...
                {
                    isHatched = false;
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x7e)))
                    {
                        eggloc = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x7e))];
                    }
                    else
                    {
                        eggloc = Convert.ToString(BitConverter.ToUInt16(data, 0x7e));
                    }
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x80)))
                    {
                        locationmet = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x80))];
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x80)))
                    {
                        eggloc = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x80))];
                    }
                    else
                    {
                    ...
                    if (PkmLib.locationValuesGen4.Contains(BitConverter.ToUInt16(data, 0x7e)))
                    {
                        locationmet = PkmLib.locationsGen4[PkmLib.locationValuesGen4.IndexOf(BitConverter.ToUInt16(data, 0x7e))];
                    }
                    else
                    {
            ...
            {
                locationmet = hgssLocationMet;
                eggloc = hgssLocationHatched;
            }
            pokerus = data[130];
        ...
        /// </summary>
        public PokemonGen4(UInt32 _pid, string _species, string _item, string _ability, string _nature, UInt32 _level, byte[] _iv, byte[] _ev, string[] _moves, byte[] _ppups,
        ...
        /// </summary>
        public PokemonGen4(byte[] data, bool decryptData = false)
        {
        ...
        public void save(bool isParty = true)
        {
            ...
            data[0x1c] = saev;
            data[0x1d] = sdev;
            data[0x1e] = contest_Cool;
            data[0x1f] = contest_Beauty;
            data[0x20] = contest_Cute;
            data[0x21] = contest_Smart;
            data[0x22] = contest_Tough;
            data[0x23] = contest_Sheen;
            ...
            while (z < 10)
            {
                ...
                else
                {
                    ...
                    {
                        nicku = PkmLib.getGen4Char((ushort)temp.First());
            ...
            if (version != "Heart Gold" && version != "Soul Silver")
            {
                ...
                else
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(eggloc)])), 0, data, 0x80, 2);
                    }
                }
                if (isHatched)
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(locationmet)])), 0, data, 0x7e, 2);
                    }
                }
                else
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(locationmet)])), 0, data, 0x80, 2);
                    }
                }
            }
            else
            {
                if (isHatched == false)
                {
                    data[0x7e] = 0;
                    data[0x7f] = 0;
                    Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(0xbba)), 0, data, 0x80, 2);
                }
                else
                {
                    Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(0xbba)), 0, data, 0x7e, 2);
                    Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(0xbba)), 0, data, 0x80, 2);
                }
                if (isHatched == false)
                {
                ...
                else
                {
                    if (ushort.TryParse(eggloc, out parseTemp))
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(eggloc)), 0, data, 0x46, 2);
                    }
                    else
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(eggloc)])), 0, data, 0x46, 2);
                    }
                }
                if (isHatched)
                {
                    if (ushort.TryParse(locationmet, out parseTemp))
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(locationmet)), 0, data, 0x44, 2);
                    }
                    else
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(locationmet)])), 0, data, 0x44, 2);
                    }
                }
                else
                {
                    if (ushort.TryParse(locationmet, out parseTemp))
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(locationmet)), 0, data, 0x46, 2);
                    }
                    else
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValuesGen4[PkmLib.locationsGen4.IndexOf(locationmet)])), 0, data, 0x46, 2);
                    }
                }
            }
            data[0x82] = pokerus;
        ...
        /// <summary>
        /// Return a copy of the PokemonGen4 object
        /// </summary>
        /// <returns>Clone of a PokemonGen4 object</returns>
        public PokemonGen4 Clone()
        {
            return this.MemberwiseClone() as PokemonGen4;
        }
        ...
        {
            save();
            PokemonGen4 temp = new PokemonGen4(data);
            temp.encrypt();
            if (party)
            {
                return temp.data;
