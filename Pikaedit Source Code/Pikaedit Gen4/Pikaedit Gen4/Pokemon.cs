...
namespace Pikaedit_Gen4
{
    ...
    public class Pokemon
    {
        ...
        private void baseStats()
        {
            ...
            if (PkmLib.getFormValue(species, form) != 0 && (species == "Meloetta" || species == "Deoxys" || species == "Kyurem" || species == "Wormadam" || species == "Shaymin" || species == "Giratina" || species == "Rotom" || species == "Tornadus" || species == "Thundurus" || species == "Landorus"))
            {
                if (form == "Attack")
                {
                    baseHP = 50;
        ...
        private void Initialize()
        {
            ...
            if (version == "Heart Gold" || version == "Soul Silver")
            {
                ...
                {
                    isHatched = false;
                    if (PkmLib.locationValues.Contains(BitConverter.ToUInt16(data, 0x44)))
                    {
                        hgssLocationHatched = PkmLib.locations[PkmLib.locationValues.IndexOf(BitConverter.ToUInt16(data, 0x44))];
                    }
                    else
                    {
                        hgssLocationHatched = Convert.ToString(BitConverter.ToUInt16(data, 0x44));
                    }
                    if (PkmLib.locationValues.Contains(BitConverter.ToUInt16(data, 0x46)))
                    {
                        hgssLocationMet = PkmLib.locations[PkmLib.locationValues.IndexOf(BitConverter.ToUInt16(data, 0x46))];
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (PkmLib.locationValues.Contains(BitConverter.ToUInt16(data, 0x46)))
                    {
                        hgssLocationHatched = PkmLib.locations[PkmLib.locationValues.IndexOf(BitConverter.ToUInt16(data, 0x46))];
                    }
                    else
                    {
                    ...
                    if (PkmLib.locationValues.Contains(BitConverter.ToUInt16(data, 0x44)))
                    {
                        hgssLocationMet = PkmLib.locations[PkmLib.locationValues.IndexOf(BitConverter.ToUInt16(data, 0x44))];
                    }
                    else
                    {
        ...
        public void save(bool isParty = true)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValues[PkmLib.locations.IndexOf(eggloc)])), 0, data, 0x46, 2);
                    }
                }
                if (isHatched)
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValues[PkmLib.locations.IndexOf(locationmet)])), 0, data, 0x44, 2);
                    }
                }
                else
                {
                    ...
                    {
                        Array.Copy(BitConverter.GetBytes(Convert.ToUInt16(PkmLib.locationValues[PkmLib.locations.IndexOf(locationmet)])), 0, data, 0x46, 2);
                    }
                }
            }
            data[0x82] = pokerus;
