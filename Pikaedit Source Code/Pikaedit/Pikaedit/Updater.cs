...
namespace Pikaedit
{
    public static class Updater
    {
        ...
        private static readonly string url = "https://dl.dropboxusercontent.com/s/oa179i83vb80m8o/version%20C%23.txt?dl=1&";
        ...
        private static void downloadUpdate_DownloadFileCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            ...
            Process.Start("updater.exe", "\"Pikaedit\" info.bin");
        ...
        private static void checkVersion_DownloadStringCompleted(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            s[1] = s[1].TrimEnd('\r');
            file = "PikaEdit " + s[0] + ".exe";
            if (!s[0].Equals(v))
            {
                log = "Pikaedit has been updated to version " + s[0].TrimEnd('.', '0')/*.TrimStart('0','.')*/ + "\nVersion changes:\n" + log;
