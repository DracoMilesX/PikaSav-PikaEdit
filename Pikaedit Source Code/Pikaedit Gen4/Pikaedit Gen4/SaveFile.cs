...
namespace Pikaedit_Gen4
{
    ...
    public class SaveFile
    {
        ...
        /// </summary>
        public Box[] boxes = new Box[18];
        /// <summary>
        /// Represents save file Pal Parked Pokemon
        /// </summary>
        public Pokemon[] palpark = new Pokemon[6];
        /// <summary>
        ...
        private void extractParty()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                this.party[i] = new Pokemon(br.ReadBytes(236));
            }
        }
        ...
        private TrainerInfo extractTrainerData()
        {
            ...
            return new TrainerInfo(name, id, sid, money, gender, badges, hgssbadges);
        }
        ...
        private DayCarePKM extractDayCare()
        {
            ...
            return new DayCarePKM(new Pokemon(br.ReadBytes(232)), new Pokemon(br.ReadBytes(232)), false);
        }
        ...
        private void extractPalPark()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                this.palpark[i] = new Pokemon(br.ReadBytes(236));
            }
        }
