...
{
    /// <summary>
    /// Represents a Pokemon data as an object (All string data is in English)
    /// </summary>
    public class Pokemon
    {
        ...
        /// <param name="decryptData">Force a decrypt, if false, it will detect if the pokemon needs to be decrypted</param>
