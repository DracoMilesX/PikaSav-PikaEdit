...
namespace Pikaedit_Lib
{
    ...
    public class PokemonXY
    {
        ...
        /// </summary>
        public PokemonXY(UInt32 _pid, string _species, string _item, string _ability, string _nature, UInt32 _level, byte[] _iv, byte[] _ev, string[] _moves, byte[] _ppups,
        ...
        /// </summary>
        public PokemonXY(byte[] data, bool decryptData = false)
        {
        ...
        public PokemonXY Clone()
        {
            return this.MemberwiseClone() as PokemonXY;
        }
