...
namespace Pikaedit_Lib
{
    ...
    public class DayCare
    {
        ...
        public DayCare(Pokemon[] pkmdata, bool hasEgg=false)
        {
            this.pkmdata = pkmdata;
            this.hasEgg = hasEgg;
        }

        public DayCare(Pokemon pkm1, Pokemon pkm2, bool hasEgg = false)
        {
            pkmdata[0] = pkm1;
            pkmdata[1] = pkm2;
            this.hasEgg = hasEgg;
        ...
        public DayCare(Pokemon pkm1, Pokemon pkm2, byte hasEgg = 0)
        {
            pkmdata[0] = pkm1;
            pkmdata[1] = pkm2;
