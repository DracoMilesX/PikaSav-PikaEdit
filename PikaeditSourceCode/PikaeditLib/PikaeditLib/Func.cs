...
namespace Pikaedit_Lib
{
    ...
    public static class Func
    {
        ...
        /// <summary>
        /// Convert a range of bytes of an array with Gen 4 character encoding to a Unicode string
        /// </summary>
        ...
        /// <summary>
        /// Convert a Unicode string into a Gen 4 encoded characters as a byte[]
        /// </summary>
        /// <param name="s">Unicode string</param>
        /// <param name="maxlength">Maximum length for the string</param>
        /// <returns>byte[] with Gen 4 encoded characters</returns>
